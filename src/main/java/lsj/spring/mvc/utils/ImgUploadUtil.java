...
public class ImgUploadUtil {
    // 이미지 업로드 경로 설정
    private String uploadPath = "/opt/homebrew/Cellar/nginx/1.21.0/html/cdn/";
    private String thumbnailPath = "/opt/homebrew/Cellar/nginx/1.21.0/html/thumb/";
    ...
    public void imageCropResize(String fname, String id) {
        ...
        // 썸내일 이미지 이름 설정
        String tfname = thumbnailPath + "small_"
                + id + "_" + fname;
